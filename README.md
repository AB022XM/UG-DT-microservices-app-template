...
To build the final jar and optimize the microservicetemplate application for production, run:
...
Then navigate to [http://localhost:9581](http://localhost:9581) in your browser.
